...
- While logged into your GitHub account, navigate to the
  ``python-redis`` `repo`_ on GitHub.

- Fork and clone the ``python-redis`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-redis`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-redis``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-redis.git hack-on-python-redis
   $ cd hack-on-python-redis
...
.. _repo: https://github.com/googleapis/python-redis
