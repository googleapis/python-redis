...
_UPGRADEINSTANCEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="google.cloud.redis.v1beta1.UpgradeInstanceRequest.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="redis_version",
            full_name="google.cloud.redis.v1beta1.UpgradeInstanceRequest.redis_version",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
Instance = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          and [alternative_location_id][google.cloud.redis.v1beta1.Insta
          nce.alternative_location_id] fields for more details.
      display_name:
      ...
      location_id:
          ...
          ocation_id][google.cloud.redis.v1beta1.Instance.alternative_lo
          cation_id] is also provided, it must be different from [locati
          on_id][google.cloud.redis.v1beta1.Instance.location_id].
      alternative_location_id:
          ...
          one provided in [location_id][google.cloud.redis.v1beta1.Insta
          nce.location_id].
      redis_version:
      ...
      current_location_id:
          ...
          [location_id][google.cloud.redis.v1beta1.Instance.location_id]
          or [alternative_location_id][google.cloud.redis.v1beta1.Instan
          ce.alternative_location_id] and can change after a failover
          event.
      create_time:
...
ListInstancesRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      page_size:
          ...
          _page_token] to determine if there are more instances left to
          be queried.
      page_token:
